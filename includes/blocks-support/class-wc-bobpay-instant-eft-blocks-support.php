...
final class WC_Bobpay_Instant_EFT_Blocks_Support extends AbstractPaymentMethodType
{
	protected $name = 'bobpay_instant_eft';

	public function initialize()
	{
		$this->settings = get_option('woocommerce_bobpay_instant_eft_settings', []);
	}
	...
	public function is_active()
	{
		...
		return $payment_gateways['bobpay_instant_eft']->is_available();
	}
	...
	public function get_payment_method_script_handles()
	{
		...
		wp_register_script(
			'wc-bobpay-instant-eft-blocks-integration',
		...
		return ['wc-bobpay-instant-eft-blocks-integration'];
	}

	public function get_supported_features()
	{
		$payment_gateways = WC()->payment_gateways->payment_gateways();
		return $payment_gateways['bobpay_instant_eft']->supports;
	}
}
